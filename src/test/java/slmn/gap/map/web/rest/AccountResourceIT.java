package slmn.gap.map.web.rest;

import static org.assertj.core.api.Assertions.assertThat;
import static org.springframework.test.web.servlet.request.MockMvcRequestBuilders.*;
import static org.springframework.test.web.servlet.result.MockMvcResultMatchers.*;
import static slmn.gap.map.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
import slmn.gap.map.config.Constants;
import slmn.gap.map.domain.User;
import slmn.gap.map.repository.AuthorityRepository;
import slmn.gap.map.repository.UserRepository;
import slmn.gap.map.security.AuthoritiesConstants;
import slmn.gap.map.service.UserService;
import slmn.gap.map.service.dto.AdminUserDTO;
import slmn.gap.map.service.dto.PasswordChangeDTO;
import slmn.gap.map.service.dto.UserDTO;
import slmn.gap.map.web.rest.vm.KeyAndPasswordVM;
import slmn.gap.map.web.rest.vm.ManagedUserVM;
